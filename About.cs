	...
	public partial class About : Form
	{
		...
		struct Lang_keys
		{
			public string about_name, about_name_2, apply, auto_help, auto_name, auto_text,
				...
				manual_name, manual_text, mode_desc_name, mode_sel, OK, reset, restart, site_link,
		...
		public About(string lang_set)
		{
			...
			if (lang_set == "ru-RU")
			{
				...
				lang_Keys.site_link = Resources.lang_RU.site_link;
			...
			else if (lang_set == "en")
			{
				...
				lang_Keys.site_link = Resources.lang_EN.site_link;
			...
			label3.Text = lang_Keys.site_link;
		}
		...
		{
			System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo("https://kitfatr.github.io/Carrier/") { UseShellExecute = true });
		}
	}
}
